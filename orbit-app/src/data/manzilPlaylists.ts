...
export const BACKLOG_CHAPTERS: Chapter[] = [
  ...
  { id: "phy-15", subject: "Physics", classLevel: 12, chapter: "Current Electricity", duration: "07h 30m", weightage: "High" },
  { id: "phy-16", subject: "Physics", classLevel: 12, chapter: "Moving Charges & Magnetism", duration: "06h 50m", weightage: "High" },
  ...
  { id: "math-2", subject: "Mathematics", classLevel: 11, chapter: "Trigonometric Ratios & Identities", videoId: "DitLpxy6V48", duration: "06h 15m", weightage: "Core" },
  { id: "math-3", subject: "Mathematics", classLevel: 11, chapter: "Quadratic Equations", duration: "05h 10m", weightage: "High" },
  { id: "math-4", subject: "Mathematics", classLevel: 11, chapter: "Complex Numbers", duration: "06h 50m", weightage: "High" },
  { id: "math-5", subject: "Mathematics", classLevel: 11, chapter: "Binomial Theorem", videoId: "QMWDHOcXEQI", duration: "05h 10m", weightage: "High" },
  ...
  // ==================== PHYSICAL CHEMISTRY ====================
  { id: "pc-1", subject: "Physical Chemistry", classLevel: 11, chapter: "Mole Concept & Stoichiometry", duration: "05h 15m", weightage: "Core" },
  { id: "pc-2", subject: "Physical Chemistry", classLevel: 11, chapter: "Structure of Atom", duration: "05h 45m", weightage: "High" },
  { id: "pc-3", subject: "Physical Chemistry", classLevel: 11, chapter: "Chemical Thermodynamics", duration: "07h 15m", weightage: "High" },
  { id: "pc-4", subject: "Physical Chemistry", classLevel: 11, chapter: "Chemical & Ionic Equilibrium", duration: "07h 50m", weightage: "High" },
  { id: "pc-5", subject: "Physical Chemistry", classLevel: 11, chapter: "Redox Reactions", duration: "03h 20m", weightage: "Core" },
  { id: "pc-6", subject: "Physical Chemistry", classLevel: 12, chapter: "Solutions & Colligative Properties", duration: "05h 30m", weightage: "High" },
  { id: "pc-7", subject: "Physical Chemistry", classLevel: 12, chapter: "Electrochemistry", duration: "06h 40m", weightage: "High" },
  { id: "pc-8", subject: "Physical Chemistry", classLevel: 12, chapter: "Chemical Kinetics", duration: "05h 45m", weightage: "High" },

  // ==================== ORGANIC CHEMISTRY ====================
  { id: "oc-1", subject: "Organic Chemistry", classLevel: 11, chapter: "IUPAC Nomenclature & Isomerism", duration: "04h 45m", weightage: "Core" },
  { id: "oc-2", subject: "Organic Chemistry", classLevel: 11, chapter: "General Organic Chemistry (GOC)", videoId: "FFCT-lh86tA", duration: "07h 20m", weightage: "High" },
  { id: "oc-3", subject: "Organic Chemistry", classLevel: 11, chapter: "Hydrocarbons", videoId: "02CBTEOMMsA", duration: "06h 05m", weightage: "High" },
  { id: "oc-4", subject: "Organic Chemistry", classLevel: 12, chapter: "Haloalkanes & Haloarenes", duration: "05h 30m", weightage: "High" },
  { id: "oc-5", subject: "Organic Chemistry", classLevel: 12, chapter: "Alcohols, Phenols & Ethers", duration: "06h 00m", weightage: "High" },
  { id: "oc-6", subject: "Organic Chemistry", classLevel: 12, chapter: "Aldehydes, Ketones & Carboxylic Acids", duration: "07h 45m", weightage: "High" },
  { id: "oc-7", subject: "Organic Chemistry", classLevel: 12, chapter: "Amines & Diazonium Salts", duration: "04h 45m", weightage: "High" },
  { id: "oc-8", subject: "Organic Chemistry", classLevel: 12, chapter: "Biomolecules", duration: "03h 50m", weightage: "High" },

  // ==================== INORGANIC CHEMISTRY ====================
  { id: "ioc-1", subject: "Inorganic Chemistry", classLevel: 11, chapter: "Periodic Classification of Elements", videoId: "nLE7_YBFQNQ", duration: "04h 40m", weightage: "High" },
  { id: "ioc-2", subject: "Inorganic Chemistry", classLevel: 11, chapter: "Chemical Bonding & Molecular Structure", duration: "07h 30m", weightage: "High" },
  { id: "ioc-3", subject: "Inorganic Chemistry", classLevel: 12, chapter: "Coordination Compounds", duration: "07h 00m", weightage: "High" },
